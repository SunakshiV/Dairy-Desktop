...
import 'package:dairy_newdeskapp/model/AddpaymentsResponse.dart';
...
import 'package:dairy_newdeskapp/model/PayemtnListResponse.dart';
import 'package:dairy_newdeskapp/model/PaymentFilterGetResponse.dart';
...
class PaymentsState extends State<Payments> {
  ...
  PaymentFilterGetResponse user2;
  var listdata2;
  ...
  final BillNumberFocus = FocusNode();
  ...
  Future<void> addMilkCollection(
    ...
    final formData = {
      ...
      'bill_number': Controllers.milk_weight.text,
      'vendor_code': textValue,
      'vendor_name': Controllers.milk_vendor_name.text,
      'amount': Controllers.milk_amount.text,
      'notes': Controllers.milk_rate.text,
      'credit_debit': dropdownValueSpinner,
      'user_id': _userId
    };
    print("payments" + dropdownValueSpinner);
    try {
      Dio _dio = new Dio();
      _dio.options.contentType = Headers.formUrlEncodedContentType;
      final responseData = await _dio.post<Map<String, dynamic>>(
          '/api/adddesktoppayments',
      ...
      AddpaymentsResponse user =
          AddpaymentsResponse.fromJson(responseData.data);
      if (user.status == 200) {
  ...
  void getMilkCollections(int user_id,int page) async {
    ...
    http.Response response = await http.post(ApiBaseUrl.base_url +"api/desktoppayments_list", body: data);
    if (response.statusCode == 200)
    {
      ...
      if (jsonResponse["status"] == 200) {
        ...
        user1 = new PayemtnListResponse.fromJson(jsonResponse);
  ...
  void nextscreen(int id) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => EditPaymentSale(id)),
    );
  }
    ...
    try {
      ...
      final responseData = await _dio.post<Map<String, dynamic>>(
          ...
          options: RequestOptions(
              ...
              baseUrl: ApiBaseUrl.base_url),
          data: formData);
      user2 = PaymentFilterGetResponse.fromJson(responseData.data);
      setState(() {
        type = 'filter';
        resultvalue2 = true;
  ...
  _launchURL() async {
    String url =
        'http://shankraresearch.com/payments' + _userId.toString();
