...
class AllAccounts extends StatefulWidget {
  @override
  AllAccountsState createState() => AllAccountsState();
}

class AllAccountsState extends State<AllAccounts> {
  GlobalKey<State> _keyLoader = new GlobalKey<State>();
 // GlobalKey<State> _keyLoad = new GlobalKey<State>();
  int _userId;
  var listdata1;
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: Align(
                        ...
                        child: ListView.builder(
                            controller: _listViewController,
                            itemCount: listdataitem.length == null
                                ? 0
                                : listdataitem.length,
                            itemBuilder: (BuildContext context,
                                int index) {
                              return Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    //   width: MediaQuery.of(context).size.width/2,
                                    child: SelectableText(
                                      listdataitem.elementAt(index).vendorCode,
                                      maxLines: 1,
                                      style: TextStyle(
                                          color:
                                          AppColors.black,
  ...
  _launchURL() async {
    String url =
        'http://shankraresearch.com/excelDownload' + _userId.toString();
  ...
  _launchPdfURL() async {
    String url =
        'https://shankraresearch.com/AccReport/' + _userId.toString();
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
