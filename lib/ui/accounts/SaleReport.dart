...
import 'package:dairy_newdeskapp/model/ItemSaleFilter.dart';
import 'package:dairy_newdeskapp/model/ItemSaleListResponse.dart';
import 'package:dairy_newdeskapp/model/MilkSaleFilter.dart';
...
import 'package:dairy_newdeskapp/ui/task/EditMilkSale.dart';
...
class SaleReportState extends State<SaleReport> {
  ...
  String radioButtonItem = 'Milk Sale';
  ...
  MilkSaleFilter useritem;
  ItemSaleFilter usermilk;
  ...
  _loadID() async {
    ...
    setState(() {
      ...
      print("newid" + id.toString());
      print("newid" + type.toString());
                                                          ...
                                                          return Row(
                                                            children: [
                                                              ...
                                                              InkWell(
                                                                ...
                                                                onTap: () {
                                                                  nextscreen(   user2.paginationData.data
                                                                      .elementAt(
                                                                          index)
                                                                      .id);
                                                                },
  ...
  void getCheckValues(int index) {
    if (id == 1) {
      if (_selected_box.contains(index)) {
        ...
        tmpArray.remove(   user2.paginationData.data.elementAt(index).id);
      } else {
        _selected_box.add(index);
        tmpArray.add(   user2.paginationData.data.elementAt(index).id);
      }
  ...
  void nextscreen(int ids) {
    if (id == 1) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => EditMilkSale(ids)),
      );
    }
  }
  ...
  Future<void> getMilkCollections(
    ...
    try {
      ...
      final responseData = await _dio.post<Map<String, dynamic>>(
          '/api/reportitemsalelist',
          options: RequestOptions(
              method: 'POST',
              headers: <String, dynamic>{},
              baseUrl: ApiBaseUrl.base_url),
          data: formData);
      user1 = ItemSaleListResponse.fromJson(responseData.data);
      setState(() {
        type = 'normal';
        resultvalue1 = true;
  ...
  Future<void> getItemCollections(
    ...
    try {
      ...
      _dio.options.contentType = Headers.formUrlEncodedContentType;
      final responseData = await _dio.post<Map<String, dynamic>>(
          '/api/milksaleslistreport',
          options: RequestOptions(
              method: 'POST',
              headers: <String, dynamic>{},
              baseUrl: ApiBaseUrl.base_url),
          data: formData);
      user2 = MilkSaleResponse.fromJson(responseData.data);
      setState(() {
        type = 'normal';
        resultvalue2 = true;
        listdata2 =    user2.paginationData.data;
      });
    } catch (e) {
      setState(() {
        resultvalue2 = false;
  ...
  Future<void> getItemFilterList(
    ...
    print("responsesend" + formData.toString());
    try {
      Dio _dio = new Dio();
      _dio.options.contentType = Headers.formUrlEncodedContentType;
      final responseData = await _dio.post<Map<String, dynamic>>(
          '/api/reportfiltermilksale',
          options: RequestOptions(
              method: 'POST',
              headers: <String, dynamic>{},
              baseUrl: ApiBaseUrl.base_url),
          data: formData);
      useritem = MilkSaleFilter.fromJson(responseData.data);
      setState(() {
        type = 'filter';
        resultvalueitem = true;
        listdataitem = useritem.data;
        print("response" + useritem.data.elementAt(0).vendorName);
      });
    } catch (e) {
  ...
  Future<void> getMilkFilterList(
    ...
    try {
      ...
      _dio.options.contentType = Headers.formUrlEncodedContentType;
      final responseData = await _dio.post<Map<String, dynamic>>(
          '/api/reportfilteritemsale',
          options: RequestOptions(
              method: 'POST',
              headers: <String, dynamic>{},
              baseUrl: ApiBaseUrl.base_url),
          data: formData);
      usermilk = ItemSaleFilter.fromJson(responseData.data);
      setState(() {
        type = 'filter';
