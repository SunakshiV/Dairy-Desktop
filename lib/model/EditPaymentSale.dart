...
class EditPaymentSale extends StatefulWidget {
  int _id;
  EditPaymentSale(int id) {
    this._id = id;
  }
  @override
  EditPaymentSaleState createState() => EditPaymentSaleState();
}

class EditPaymentSaleState extends State<EditPaymentSale> {
